...
class ClipMatcher(nn.Module):
    ...
    @nvtx.annotate("match_for_single_frame", color="gray")
    def match_for_single_frame(self,
        ...
        with nvtx.annotate("update pre track", color="red"):
            for j in range(len(track_instances)):
                with nvtx.annotate("update per ins", color="green"):
        ...
        @nvtx.annotate("match_for_single_decoder_layer", color="yellow")
        ...
        with nvtx.annotate("update new match", color="orange"):
        ...
        with nvtx.annotate("cal loss", color="black"):
            for loss in self.losses:
                with nvtx.annotate("loss", color="purple"):
