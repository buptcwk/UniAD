...
class UniAD(UniADTrack):
    ...
    def forward_train(self,
        ...
        losses_track = None
        outs_track = None
        with nvtx.annotate("forward_track_train", color="blue"):
        ...
        with nvtx.annotate("losses_track", color="green"):
        ...
        if self.with_seg_head:
            with nvtx.annotate("with_seg_head", color="red"):
        ...
        if self.with_motion_head:
            with nvtx.annotate("motion_head", color="yellow"):
        ...
        if self.with_occ_head:
            with nvtx.annotate("occ_head", color="white"):
        ...
        if self.with_planning_head:
            with nvtx.annotate("planning_head", color="black"):
