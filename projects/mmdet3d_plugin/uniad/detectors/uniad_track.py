...
class UniADTrack(MVXTwoStageDetector):
    ...
    @nvtx.annotate("extract_img_feat", color="red")
    def extract_img_feat(self, img, len_queue=None):
        ...
        img_feats = None
        with nvtx.annotate("img_backbone", color="white"):
        ...
        img_feats_reshaped = []
        with nvtx.annotate("for_loop_img_feats", color="yellow"):
            for img_feat in img_feats:
                with nvtx.annotate("img_feats", color="green"):
    ...
    @nvtx.annotate("get_history_bev", color="yellow")
    def get_history_bev(self, imgs_queue, img_metas_list):
        ...
        with torch.no_grad():
            ...
            with nvtx.annotate("for len_queue", color="purple"):
                for i in range(len_queue):
                    with nvtx.annotate("get each bev", color="orange"):
    ...
    @nvtx.annotate("get_bevs", color="black")
    ...
    def _forward_single_frame_train(
        ...
        with nvtx.annotate("for_loop_nb_dec", color="orange"):
    ...
    @nvtx.annotate("select_active_track_query", color="purple")
    ...
    @nvtx.annotate("select_sdc_track_query", color="green")
    ...
    def forward_track_train(self,
        ...
        out = dict()
        with nvtx.annotate("forward_multi_frame_train", color="green"):
            for i in range(num_frame):
                with nvtx.annotate("forward_single_frame_train", color="blue"):
