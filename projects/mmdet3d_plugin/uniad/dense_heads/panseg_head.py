...
class PansegformerHead(SegDETRHead):
    ...
    def forward(self, bev_embed):
        ...
        with nvtx.annotate("position_encoding", color="red"):
        ...
        query_embeds = None
        with nvtx.annotate("seg transformer", color="green"):
            if not self.as_two_stage:
        ...
        for lvl in range(hs.shape[0]):
            with nvtx.annotate("for loop hs", color="green"):
                if lvl == 0:
    ...
    @nvtx.annotate("loss_single_panoptic", color="purple")
    ...
    def forward_train(self,
        ...
        """
        pred_seg_dict = None
        with nvtx.annotate("seg forward", color="yellow"):
